...
// TO DO: Implement a missing trait so that `main()` below will compile. It
...
impl Display for ParseClimateError {
    // TO DO: Complete this function so that it produces the correct strings
...
impl FromStr for Climate {
    ...
    // TO DO: Complete this function by making it handle the missing error
    // cases.
